...
public class project_detail_edit_page extends AppCompatActivity {
    ...
    void openObject_project_detail_edit(){
        // forum
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(project_detail_edit_page.this, MainActivity.class);
        ...
        task.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(project_detail_edit_page.this, project_page.class);
                startActivity(intent);
            }
        });
        ...
        person.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(project_detail_edit_page.this, profile_page.class);
                startActivity(intent);
            }
        });
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(project_detail_edit_page.this, setting_page.class);
                startActivity(intent);
            }
        });
        ...
        imgbtnnotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(project_detail_edit_page.this, notification_page.class);
                startActivity(intent);
            }
        });
