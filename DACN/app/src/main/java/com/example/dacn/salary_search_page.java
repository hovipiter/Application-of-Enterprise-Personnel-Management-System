...
public class salary_search_page extends AppCompatActivity {
    // thanh dashboard
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.salary_search_page);
    ...
    public void openObject_salary(){
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(salary_search_page.this, MainActivity.class);
        ...
        task.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(salary_search_page.this, project_page.class);
                startActivity(intent);
            }
        });
        ...
        person.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(salary_search_page.this, profile_page.class);
                startActivity(intent);
            }
        });
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(salary_search_page.this, setting_page.class);
                startActivity(intent);
            }
        });
        ...
        imgbtnnotification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(salary_search_page.this, notification_page.class);
                startActivity(intent);
            }
        });
        imgback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(salary_search_page.this, salary_page.class);
                startActivity(intent);
            }
        });
    }
